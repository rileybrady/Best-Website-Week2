...
function checkYes(el){
	...
	//I believe this is my most complicated piece of Java, the quantity of the code is not much but to me 
	//it is very complex since it apply's to HTML and CSS attributes.
